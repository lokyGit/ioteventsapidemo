...
const AmplifyTOTPSetup = class {
    ...
    render() {
        return (h("amplify-form-section", { headerText: I18n.get(Translations.TOTP_HEADER_TEXT), submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading }, h("div", { class: "totp-setup" }, h("img", { src: this.qrCodeImageSource, alt: I18n.get(Translations.QR_CODE_ALT) }), h("amplify-form-field", { label: I18n.get(Translations.TOTP_LABEL), inputProps: this.inputProps, fieldId: "totpCode", name: "totpCode", handleInputChange: event => this.handleTotpInputChange(event) }))));
    }
};
