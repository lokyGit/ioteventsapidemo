...
const Translations = require('./Translations-5c122e5e.js');
const constants = require('./constants-c7bbe67d.js');
const auth = require('@aws-amplify/auth');
const helpers = require('./helpers-c09e38da.js');
...
const AmplifyForgotPassword = class {
    ...
    handleFormFieldInputWithCallback(event, field) {
        ...
        const callback = field.type === 'phone_number'
...
const AmplifyRequireNewPassword = class {
    ...
    async completeNewPassword(event) {
        ...
        try {
            ...
            const user = await auth.Auth.completeNewPassword(this.user, this.password, requiredAttributes);
...
const AmplifySignIn = class {
    ...
    render() {
        return (index.h("amplify-form-section", { headerText: this.headerText, handleSubmit: this.handleSubmit, testDataPrefix: 'sign-in' }, index.h("amplify-federated-buttons", { handleAuthStateChange: this.handleAuthStateChange, federated: this.federated }), !core.isEmpty(this.federated) && index.h("amplify-strike", null, "or"), index.h("amplify-auth-fields", { formFields: this.newFormFields }), index.h("div", { slot: "amplify-form-section-footer", class: "sign-in-form-footer" }, index.h("span", null, core.I18n.get(Translations.Translations.NO_ACCOUNT_TEXT), ' ', index.h("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(authTypes.AuthState.SignUp), "data-test": "sign-in-create-account-link" }, core.I18n.get(Translations.Translations.CREATE_ACCOUNT_TEXT))), index.h("amplify-button", { type: "submit", disabled: this.loading, "data-test": "sign-in-sign-in-button" }, index.h("amplify-loading-spinner", { style: { display: this.loading ? 'initial' : 'none' } }), index.h("span", { style: { display: this.loading ? 'none' : 'initial' } }, this.submitButtonText)))));
    }
};
...
const AmplifySignUp = class {
    ...
    render() {
        return (index.h("amplify-form-section", { headerText: this.headerText, handleSubmit: this.handleSubmit, testDataPrefix: 'sign-up' }, index.h("amplify-auth-fields", { formFields: this.newFormFields }), index.h("div", { class: "sign-up-form-footer", slot: "amplify-form-section-footer" }, index.h("span", null, this.haveAccountText, ' ', index.h("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(authTypes.AuthState.SignIn), "data-test": "sign-up-sign-in-link" }, this.signInText)), index.h("amplify-button", { type: "submit", "data-test": "sign-up-create-account-button" }, index.h("amplify-loading-spinner", { style: { display: this.loading ? 'initial' : 'none' } }), index.h("span", { style: { display: this.loading ? 'none' : 'initial' } }, this.submitButtonText)))));
    }
};
...
const AmplifyVerifyContact = class {
    ...
    renderSubmit() {
        return (index.h("div", null, index.h("amplify-input", { inputProps: {
                autocomplete: 'off',
            }, name: "code", placeholder: core.I18n.get(Translations.Translations.CODE_PLACEHOLDER) })));
    }
    renderVerify() {
        ...
        return (index.h("div", null, email && (index.h("amplify-radio-button", { label: core.I18n.get(Translations.Translations.VERIFY_CONTACT_EMAIL_LABEL), key: "email", name: "contact", value: "email" })), phone_number && (index.h("amplify-radio-button", { label: core.I18n.get(Translations.Translations.VERIFY_CONTACT_PHONE_LABEL), key: "phone_number", name: "contact", value: "phone_number" }))));
    }
    render() {
