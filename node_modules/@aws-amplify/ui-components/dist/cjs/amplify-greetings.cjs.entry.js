...
const AmplifyGreetings = class {
    ...
    render() {
        return (index.h("header", { class: "greetings" }, this.logo && index.h("span", null, this.logo), index.h("amplify-nav", null, this.username && index.h("span", { slot: "greetings-message" }, "Hello, ", this.username), index.h("amplify-sign-out", { handleAuthStateChange: this.handleAuthStateChange }))));
    }
};
