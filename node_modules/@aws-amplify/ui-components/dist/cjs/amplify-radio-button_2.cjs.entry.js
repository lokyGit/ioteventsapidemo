...
const AmplifyTOTPSetup = class {
    ...
    render() {
        return (index.h("amplify-form-section", { headerText: core.I18n.get(Translations.Translations.TOTP_HEADER_TEXT), submitButtonText: core.I18n.get(Translations.Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading }, index.h("div", { class: "totp-setup" }, index.h("img", { src: this.qrCodeImageSource, alt: core.I18n.get(Translations.Translations.QR_CODE_ALT) }), index.h("amplify-form-field", { label: core.I18n.get(Translations.Translations.TOTP_LABEL), inputProps: this.inputProps, fieldId: "totpCode", name: "totpCode", handleInputChange: event => this.handleTotpInputChange(event) }))));
    }
};
