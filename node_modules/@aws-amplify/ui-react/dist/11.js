...
function () {
  ...
  class_1.prototype.componentWillLoad = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["A"], function (_a) {
              var _b = _a.payload,
                  event = _b.event,
                  data = _b.data;
              ...
              switch (event) {
                case 'cognitoHostedUI':
                  return _this.onAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn, data);

                case 'cognitoHostedUI_failure':
                case 'parsingUrl_failure':
                case 'signOut':
                case 'customGreetingSignOut':
                  return _this.onAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn, null);
              }
            });
            _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["U"], function (data) {
              var payload = data.payload;

              switch (payload.event) {
                case _constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["T"]:
                  if (payload.message) _this.toastMessage = payload.message;
                  break;

                case _constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["a"]:
                  if (payload.message) {
            ...
            Object(_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_4__["appendToCognitoUserAgent"])('amplify-authenticator');
            byHostedUI = localStorage.getItem(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["S"]);
            localStorage.removeItem(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["S"]);
  ...
  class_1.prototype.checkUser = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_4__["Auth"] || typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_4__["Auth"].currentAuthenticatedUser !== 'function') {
              throw new Error(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["N"]);
            }
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_4__["Auth"].currentAuthenticatedUser()];

          case 2:
            user = _a.sent();
            this.onAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn, user);
            return [3
            /*break*/
            , 9];
          ...
          case 3:
            ...
            try {
              cachedAuthState = localStorage.getItem(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["b"]);
            } catch (error) {
          ...
          case 4:
            ...
            return [4
            /*yield*/
            , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_4__["Auth"].signOut()];
  ...
  class_1.prototype.renderAuthComponent = function (authState) {
    switch (authState) {
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn:
        return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "sign-in"
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in", {
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ConfirmSignIn:
        ...
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-confirm-sign-in", {
          user: this.authData
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignUp:
        return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "sign-up"
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-up", {
          usernameAlias: this.usernameAlias
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ConfirmSignUp:
        ...
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-confirm-sign-up", {
          user: this.authData,
          usernameAlias: this.usernameAlias
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ForgotPassword:
        ...
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-forgot-password", {
          usernameAlias: this.usernameAlias
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ResetPassword:
        ...
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-require-new-password", {
          user: this.authData
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].VerifyContact:
        return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "verify-contact"
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-verify-contact", {
          user: this.authData
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].TOTPSetup:
        return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "totp-setup"
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-totp-setup", {
          user: this.authData
        }));
      ...
      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].Loading:
        return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "loading"
        }, Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, "Loading..."));

      case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn:
        return [Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
          name: "greetings"
        }), Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)];
  ...
  class_1.prototype.componentDidUnload = function () {
    ...
    _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].remove(_constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["U"], function (data) {
      var payload = data.payload;

      if (payload.event === _constants_206817b9_js__WEBPACK_IMPORTED_MODULE_3__["T"] && payload.message) {
  ...
  class_1.prototype.render = function () {
    ...
    return Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, this.toastMessage ? Object(_index_aae9287b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-toast", {
